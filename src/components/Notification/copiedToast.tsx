...
export default function CopiedToast(props: ICopiedToastProps) {
  ...
  return (
    <div
      id="toast"
      className="flex gap-1.5 h-[36px] items-center justify-center pl-3 pr-4 bg-primary-red rounded-2xl absolute xl:bottom-[45px] w-[340px] bottom-[70px]  mx-auto left-0 right-0"
    >
